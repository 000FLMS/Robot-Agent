...
def _chat_react(maze, persona, focused_event, reaction_mode, personas):
  ...
  if target_persona.name == "He Sihan":
    target_persona.scratch.act_start_time = init_persona.scratch.act_start_time
    target_persona.scratch.curr_time = init_persona.scratch.curr_time
